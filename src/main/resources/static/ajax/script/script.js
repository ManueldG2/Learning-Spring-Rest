    ...
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
                    ...
                    $.each(msg, function(a, b){
                            ...
                            el += "<div class = 'modulo'>";
                            el += "<div><input type='submit' id=" + b.id + " onclick='del(this)' value='cancella'>";
                            el += "<a  href = './updateJson.html?id=" + b.id + "' class='button' id=" + b.id + ">modifica </a> </div>";//passare valore id
                            el += "</div>";
                            el += "</ul>\n</li>";
